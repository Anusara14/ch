...
class ScrollHandler {
    ...
    init() {
        this.scrollToTopBtn = document.getElementById('scrollTop') || this.createScrollToTopButton();
...
class MapHandler {
    constructor() {
        ...
        this.centerLat = 6.4000;
        this.centerLng = 80.5000;
    }
    ...
    addMarkers() {
        ...
        const villageBoundary = L.polygon([
            ...
            fillOpacity: 0.3,
            weight: 2
        }).addTo(this.map).bindPopup('<b>Rambuka Village Boundary</b><br>Approximate administrative area');
    ...
    bindEvents() {
        ...
        if (downloadGeoJSONBtn) {
            downloadGeoJSONBtn.addEventListener('click', () => this.downloadGeoJSON());
        }
...
Rambuka Village Center,Settlement,${this.centerLat},${this.centerLng},"Population: 2318, Area: 1159 km²"
Stone Columns,Attraction,${this.centerLat + 0.02},${this.centerLng + 0.015},Ancient geological formation
Sinharaja Forest Border,Conservation,${this.centerLat - 0.03},${this.centerLng - 0.02},UNESCO World Heritage Site
Mountain Stream,Water Source,${this.centerLat + 0.01},${this.centerLng - 0.01},Year-round fresh water
Agricultural Zone,Agriculture,${this.centerLat - 0.015},${this.centerLng + 0.02},Traditional farming area`;
    ...
    initLandUseChart(canvas) {
        try {
            ...
            const chart = new Chart(ctx, {
                type: 'pie',
                data: {
                    labels: ['Forest (65%)', 'Agriculture (25%)', 'Settlement (8%)', 'Water (2%)'],
                    datasets: [{
                        data: [65, 25, 8, 2],
                        backgroundColor: [
                            '#4C8C4A',
            ...
            const chart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        label: 'Rainfall (mm)',
                        data: [150, 100, 180, 220, 380, 400, 350, 300, 250, 300, 200, 180],
                        borderColor: '#6BB6FF',
                        tension: 0.4,
                        yAxisID: 'y1'
                    }]
                ...
                options: {
                    ...
                    scales: {
                        ...
                        y1: { type: 'linear', position: 'right', beginAtZero: true, title: { display: true, text: 'Rainfall (mm)' } }
                    }
                }
            });
            this.charts.push(chart);
...
class AnimationHandler {
    ...
    observeElements() {
        // Animate containers
        const containers = document.querySelectorAll('.glass-container, .card, .container');
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { RambukaApp, Navigation, ScrollHandler, MapHandler, ChartHandler, FormHandler, AnimationHandler, Utils };
}